...
final class CommandTester
{
    ...
    private function verbosity(): int
    {
        ...
        if ($this->input->hasParameterOption('-vvv', true) || $this->input->hasParameterOption('--verbose=3',
                true) || 3 === $this->input->getParameterOption('--verbose', false, true)) {
            return OutputInterface::VERBOSITY_DEBUG;
        }

        if ($this->input->hasParameterOption('-vv', true) || $this->input->hasParameterOption('--verbose=2',
                true) || 2 === $this->input->getParameterOption('--verbose', false, true)) {
            return OutputInterface::VERBOSITY_VERY_VERBOSE;
        }

        if ($this->input->hasParameterOption('-v', true) || $this->input->hasParameterOption('--verbose=1',
                true) || $this->input->hasParameterOption('--verbose',
                true) || $this->input->getParameterOption('--verbose', false, true)) {
